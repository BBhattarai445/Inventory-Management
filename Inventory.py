...
def show_company_logo(width=200):
    logo_path = f"https://github.com/BBhattarai445/Inventory-Management/blob/main/Picture1.png"
...
with title_col:
    ...
    st.title(st.image("Picture1.png", width=150) "Laserax Inventory Manager")
